...
import { Loader2, PlusCircle, MinusCircle, IndianRupee, ChevronLeft } from "lucide-react";
...
function ShareForm({ onSubmit, onCancel }: { onSubmit: (share: Share) => void; onCancel: () => void }) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 pb-2 border-b">
        ...
        <h3 className="font-medium">Add Share</h3>
      </div>
...
function ShareList({ shares, onRemove, totalAmount }: { shares: Share[]; onRemove: (index: number) => void; totalAmount: number }) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between text-sm sticky top-0 bg-white py-2">
...
function ExpenseForm({ onSubmit, onCancel }: ExpenseFormProps) {
  ...
  return (
    <div className="flex flex-col h-[80vh]">
            ...
            <div className="space-y-4 border rounded-lg p-4">
              {isAddingShare ? (
                <ShareForm 
                  ...
                  onCancel={() => setIsAddingShare(false)}
                />
              ) : (
                <>
                  <ShareList 
      ...
      <div className="sticky bottom-0 mt-4 pt-4 px-4 border-t bg-white flex justify-end gap-2">
